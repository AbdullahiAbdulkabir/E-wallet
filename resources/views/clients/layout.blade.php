                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="{{ route('paywithpaypal') }}"><i class="fa fa-money"></i>From Paystack</a></li>
                                        {{-- <li><a href="{{ route('cardview') }}" disabled><i class="fa fa-credit-card"></i>From Card</a></li> --}}
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ route('withdraw')}}"><i class="fa fa-table"></i>Withdraw</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
